...
public class CustomeExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handelUserNotFoundExceptions(VehicleNotFoundException vehicleNotFoundException, WebRequest request) {
		ExceptionResponse exceptionResponse = new ExceptionResponse(new Integer(404), new Date()
				, vehicleNotFoundException.getMessage(), request.getDescription(false));
